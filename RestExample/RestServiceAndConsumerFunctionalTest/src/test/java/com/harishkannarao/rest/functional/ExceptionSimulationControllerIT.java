...
public class ExceptionSimulationControllerIT extends BaseIntegration {
    ...
    public void shouldGet500StatusWithMessageForCheckedException() throws Exception {
        ResponseEntity<String> response = testRestTemplate.exchange(generateCheckedExceptionUrl, HttpMethod.GET, null, String.class);
    ...
    public void shouldGet400StatusWithMessageForRuntimeException() throws Exception {
        ResponseEntity<String> response = testRestTemplate.exchange(generateRuntimeExceptionUrl, HttpMethod.GET, null, String.class);
    ...
    public void shouldGet403StatusWithMessageCodeAndDescriptionForCustomRuntimeException() throws Exception {
        ResponseEntity<String> response = testRestTemplate.exchange(generateCustomRuntimeExceptionUrl, HttpMethod.GET, null, String.class);
    ...
    public void shouldGet403StatusWithMessageCodeAndDescriptionForCustomCheckedException() throws Exception {
        ResponseEntity<String> response = testRestTemplate.exchange(generateCustomCheckedExceptionUrl, HttpMethod.GET, null, String.class);
        assertEquals(403, response.getStatusCodeValue());
        ErrorResponse errorResponse = objectMapper.readValue(response.getBody(), ErrorResponse.class);
    ...
    public void shouldGetCustomHeaderInResponseGivenACustomHeaderIsPassedInTheRequest() throws Exception {
        ...
        ResponseEntity<String> response = testRestTemplate.exchange(generateCustomCheckedExceptionUrl, HttpMethod.GET, requestEntity, String.class);
        assertEquals(403, response.getStatusCodeValue());
